  ...
  return (
    <Box sx={{ height: '100%', overflowY: 'auto', background: 'linear-gradient(135deg, #fdfbfb 0%, #ebedee 100%)' }}>
      ...
      >
        ...
        >
          <path
            d="M0,200 L0,80 Q180,20 360,60 Q540,100 720,40 Q900,-20 1080,50 Q1260,120 1440,70 L1440,200 Z"
            fill="#FDD835"
          />
        ...
        <Typography variant="h6" sx={{ mb: 2, fontStyle: 'italic', fontFamily: 'Noto Nastaliq Urdu, serif' }}>
          خاندان شیرازیہ کا شجرہ نسب
        </Typography>
        <Typography variant="body1" sx={{ maxWidth: 600, mx: 'auto', opacity: 0.9 }}>
          شیرازیہ خاندان کے شجرہ نسب میں خوش آمدید۔ یہ شجرہ حضرت آدم علیہ السلام سے لے کر انبیاء و اولیاء کرام کے واسطے سے حضرت سید محمد مالوک شاہ شیرازی رحمۃ اللہ علیہ اور ان کی اولاد تک پھیلا ہوا ہے۔
        </Typography>
      </Box>

      {/* Navigation Cards – ✅ Ali to Sherazi is fully linked */}
      <Container sx={{ py: 6 }}>
