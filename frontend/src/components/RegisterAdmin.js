    ...
    <Box sx={{ height: '100%', overflowY: 'auto', py: 4 }}>
      <Container maxWidth="sm">
        <Paper elevation={6} sx={{ p: 4, borderRadius: 4 }}>
          <Typography variant="h5" align="center" sx={{ mb: 3, fontWeight: 700, color: '#1565C0' }}>
            Admin Registration
          </Typography>
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            <TextField
              fullWidth label="Admin Registration Code" name="admin_code"
              margin="normal" value={form.admin_code} onChange={handleChange} required
              helperText="Enter the code provided by master admin."
            />
            <Button
              type="submit"
              variant="contained"
              fullWidth
              sx={{ mt: 3, mb: 1, bgcolor: '#1565C0', '&:hover': { bgcolor: '#0D47A1' } }}
            >
              Register as Admin
            </Button>
          </form>
